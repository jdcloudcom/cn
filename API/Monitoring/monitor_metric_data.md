...
```json
https://monitor.jdcloud-api.com/v1/regions/cn-north-1/metrics/memory.usage/metricData?timeInterval=1h&serviceCode=vm&resourceId=i-8qs0er9jd0&tags.1.key=role&tags.1.values.1=M
```
        ...
        "metricDatas": [
            {
                ...
                "tags": [
                    ...
                    {
                        "tagKey": "hostname",
                        "tagValue": "A01-R15-I152-201-9788HP2.JCLOUD.COM"
                    },
                    {
                        "tagKey": "project_id",
                        "tagValue": "2db5470757ca4114bfbb20fe18623618"
                    },
                    {
                        "tagKey": "resourceId",
                        "tagValue": "i-1ykf9blwxq"
                    },
                    {
                        "tagKey": "serviceCode",
                        "tagValue": "vm"
...
### 3. describeMetricsForCreateAlarm
...
```json
https://monitor.jdcloud-api.com/v1/regions/cn-north-1/metrics/memory.usage/lastDownsample?timeInterval=1h&serviceCode=vm&resourceId=i-1ykf9blwxq
```
